! function(t) {
	...
	s.prototype = {
				...
				e.timeout = setTimeout(function() {
					...
					if ("html" === e.contentType) {
						...
						if ("<" === n || "&" === n) {
							var a = "",
								h = "";
							for (h = "<" === n ? ">" : ";";
                            t.substr(s).charAt(0) !== h;) a += t.substr(s).charAt(0),
                            s++;
							s++, a += h
						}
					}
					e.timeout = setTimeout(function() {
						if (s === t.length) {
                            ...
                            e.curLoop++, e.loop === !1 || e.curLoop === e.loopCount)) return;
							e.timeout = setTimeout(function() {
								e.backspace(t, s)
							}, e.backDelay)
						} else {
							...
							e.attr ? e.el.attr(e.attr, o) : e.isInput ? e.el.val(o) : "html" === e.contentType ? e.el.html(o) : e.el.text(o), s++,
                             e.typewrite(t, s)
						}
					}, o)
				}, o)
		...
		backspace: function(t, s) {
			if (this.stop !== !0) {
				...
				e.timeout = setTimeout(function() {
                    ...
                    s > e.stopNum ? (s--, e.backspace(t, s)) : s <= e.stopNum && (e.arrayPos++, 
		...
		strings: ["soy", "lo que buscas,", "para tu empresa."],
		typeSpeed: 50,
		startDelay: 0,
		backSpeed: 50,
		backDelay: 900,
